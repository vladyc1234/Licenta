...
export class RouteManagerService {
  ...
  public DeleteContractById(id:string): Observable<any> {
    return this.http.delete(`${this.url_contract}/${id}`);
  }
  ...
  public DeleteTeamById(id:string): Observable<any> {
    return this.http.delete(`${this.url_team}/${id}`);
  }
